...
class GetOptScalaProject(info: ProjectInfo) extends DefaultProject(info)
{
  ...
  override def packageOptions: Seq[PackageOption] = MainClass("org.flaviusb.getopt_scala") :: Nil
  //override def shouldCheckOutputDirectories = false
  //override def updateAction = task { None }

  //lazy val main  = project(".", "foo", new MainProject(_))
  //lazy val tests = project(".", "foo", new MainProject(_))
  lazy val onion = task { println("Hello Onion!"); None }

  lazy val literatedocs = task {
    val p = "src" / "main" / "scala" / "net" / "flaviusb" / "getopt_scala"
    val f = p * "*.scala"
  ...
  private val repoName = "git@github.com:flaviusb/getopt-scala.git"
  private val repoDir  = "getopt-scala-gh-pages"
  private val mainDoc  = "getopt.html"
